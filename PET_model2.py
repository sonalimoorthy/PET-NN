"""Method 2: PET surrogate with mean-centered input scaling.
...
class MLP(nn.Module):
    ...
    def __call__(self, inputs):
        ...
        # -------- internal scaling (method 2: mean-centered) --------
        Tair_s = (Tair - 30.0) / 100.0
        Tmrt_s = (Tmrt - 50.0) / 100.0
        Rh_s = (Rh - 80.0) / 100.0
        Ws_l = Ws / 10 
